...
try:
    ...
    from python_os_helpers._logger_fallback import RobustLogger
try:
    from loggerplus.error_handling import format_exception_with_variables
except ImportError:
    from python_os_helpers._logger_fallback import format_exception_with_variables
...
class Path(PurePath, pathlib.Path):  # type: ignore[misc]
    ...
    if os.name == "nt":
        ...
        # Inspired by the C# code provided by KOTORModSync at https://github.com/bodencrouch/KOTORModSync
